...
const swmm_getAllowPonding = Module.cwrap('swmm_getAllowPonding', 'number', []);
const swmm_setNodePondedArea = Module.cwrap('swmm_setNodePondedArea', 'number', ['number','number']);
const swmm_getMinSurf = Module.cwrap('swmm_getMinSurf', 'number', []);
